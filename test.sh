...
for lr in {00001,00003,00010,00030,00100,00300,001000,003000,010000,030000,10000,30000}; do
	...
	python finetune.py ${image_dir} --valpart .4 --no_augmentation --learning_rate 0.$lr --momentum 0.$mom --n_freeze $freeze --run_name ${run_name} --preload --epochs 200 | tee results/${run_name}.txt
done
